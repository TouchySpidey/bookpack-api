...
module.exports = () => {
    ...
    if (process.env.BOOKPACK_SERVICE_ACCOUNT.startsWith('{')) {
        try {
            serviceAccount = JSON.parse(process.env.BOOKPACK_SERVICE_ACCOUNT);
        } catch (error) {
        ...
        serviceAccount = require(process.env.BOOKPACK_SERVICE_ACCOUNT);
    }
